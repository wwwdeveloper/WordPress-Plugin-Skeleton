...
class My_Plugin_Admin
{
     ...
     *
     * @since    1.0.0
     * @param      string $my_plugin The name of this plugin.
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->my_plugin, plugin_dir_url(__FILE__) . 'css/my-plugin-admin.css', array(), $this->version, 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->my_plugin, plugin_dir_url(__FILE__) . 'js/my-plugin-admin.js', array('jquery'), $this->version, false);
